...
subprocess.Popen(['i3-msg', 'for_window [title="lf-selection"] floating enable, resize set 800 600, move position center'])
...
# My addition about floating lf
c.fileselect.single_file.command = ['/home/shizuru/.local/bin/qb-fileselect-lf.sh', 'file']
c.fileselect.multiple_files.command = ['/home/shizuru/.local/bin/qb-fileselect-lf.sh', 'files']
c.fileselect.folder.command = ['notify-send', '文件夹选择暂不支持']
#
...
c.fonts.default_family = 'Cascadia Mono' # UI
